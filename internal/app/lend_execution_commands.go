...
func (s *runtimeState) newLendVerbExecutionCommand(verb planner.AaveLendVerb, short string) *cobra.Command {
	...
	submitCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			}, expectedIntent, "action intent does not match lend verb")
		},
	}
	...
	statusCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			return s.runStatusAction(cmd, statusActionID, expectedIntent, "action intent does not match lend verb")
		},
	}
