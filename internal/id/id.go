...
var chainBySlug = map[string]Chain{
	...
	"zksync-era":    {Name: "zkSync Era", Slug: "zksync", CAIP2: "eip155:324", EVMChainID: 324},
	"tempo":         {Name: "Tempo", Slug: "tempo", CAIP2: "eip155:4217", EVMChainID: 4217},
	"tempo mainnet": {Name: "Tempo", Slug: "tempo", CAIP2: "eip155:4217", EVMChainID: 4217},
	"tempo-mainnet": {Name: "Tempo", Slug: "tempo", CAIP2: "eip155:4217", EVMChainID: 4217},
	"presto":        {Name: "Tempo", Slug: "tempo", CAIP2: "eip155:4217", EVMChainID: 4217},
	...
	"mega-eth":      {Name: "MegaETH", Slug: "megaeth", CAIP2: "eip155:4326", EVMChainID: 4326},
	"tempo testnet": {Name: "Tempo Moderato", Slug: "tempo-moderato", CAIP2: "eip155:42431", EVMChainID: 42431},
	"tempo-testnet": {Name: "Tempo Moderato", Slug: "tempo-moderato", CAIP2: "eip155:42431", EVMChainID: 42431},
	"moderato":      {Name: "Tempo Moderato", Slug: "tempo-moderato", CAIP2: "eip155:42431", EVMChainID: 42431},
	...
	"tempo devnet":  {Name: "Tempo Devnet", Slug: "tempo-devnet", CAIP2: "eip155:31318", EVMChainID: 31318},
	"tempo-devnet":  {Name: "Tempo Devnet", Slug: "tempo-devnet", CAIP2: "eip155:31318", EVMChainID: 31318},
...
var chainByID = map[int64]Chain{
	...
	31318:  chainBySlug["tempo-devnet"],
...
var tokenRegistry = map[string][]Token{
	...
	"eip155:4217": {
		...
		{Symbol: "EURC.e", Address: "0x20c0000000000000000000001621e21f71cf12fb", Decimals: 6},
		{Symbol: "USDT0", Address: "0x20c00000000000000000000014f22ca97301eb73", Decimals: 6},
		{Symbol: "frxUSD", Address: "0x20c0000000000000000000003554d28269e0f3c2", Decimals: 6},
		{Symbol: "cUSD", Address: "0x20c0000000000000000000000520792dcccccccc", Decimals: 6},
		{Symbol: "stcUSD", Address: "0x20c00000000000000000000031f228af88888888", Decimals: 6},
	},
	"eip155:480": {
	...
	"eip155:42431": {
		...
		{Symbol: "USDC.e", Address: "0x20c0000000000000000000009e8d7eb59b783726", Decimals: 6},
		{Symbol: "EURC.e", Address: "0x20c000000000000000000000d72572838bbee59c", Decimals: 6},
	},
	"eip155:42220": {
...
func ParseAsset(input string, chain Chain) (Asset, error) {
	...
	if parts := strings.SplitN(raw, "/", 2); len(parts) == 2 && strings.Contains(parts[1], ":") {
		...
		addr := canonicalizeAddress(chain.CAIP2, address)
	...
	if chain.IsEVM() && evmAddressPattern.MatchString(raw) {
		addr := canonicalizeAddress(chain.CAIP2, raw)
		token, _ := findTokenByAddress(chain.CAIP2, addr)
		return Asset{ChainID: chain.CAIP2, AssetID: canonicalAssetID(chain.CAIP2, addr), Address: addr, Symbol: token.Symbol, Decimals: token.Decimals}, nil
	}
...
func canonicalAssetID(chainID, address string) string {
	addr := canonicalizeAddress(chainID, address)
	switch chainNamespace(chainID) {
	case "eip155":
		return fmt.Sprintf("%s/erc20:%s", chainID, addr)
	case "solana":
		return fmt.Sprintf("%s/token:%s", chainID, addr)
	default:
		return fmt.Sprintf("%s/asset:%s", chainID, addr)
	}
}
