...
```bash
defi yield opportunities --chain 1 --asset USDC --providers defillama,aave,morpho --limit 20 --results-only
```
...
- If an asset symbol cannot be resolved safely, DefiLlama may be skipped.
